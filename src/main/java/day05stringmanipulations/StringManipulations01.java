...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
       ...
       boolean result3= t.substring(t.length()-5).equals("money");
        ...
        //Note: You can use "char" and Strings in replace() parenthesis. Both datat types should be matching
        //both values should be "char" data type or both must be "String" data type.
        //You cannot make one data type as "char" the other replacment value data type as "String".
